...
- Clone the repository
    ...
    ```bash
    git clone https://github.com/Zont-Innovation/Teams-Bot-with-MCP-Clientgit
    ```
...
- Set environmental variables
    ...
    MCP_SERVER_PATH=C:/Projects/Symposium/Custom-Sitecore-MCP-Server/src/server.js
    ```
