...
class EchoBot extends botbuilder_1.ActivityHandler {
    constructor(openaiApiKey, openaiEndpoint, openaiModel, mcpServerPath) {
        super();
        // Initialize MCP client and OpenAI service
        this.mcpClient = new mcpClient_1.MCPClient(mcpServerPath);
        this.openaiService = new openaiService_1.OpenAIService(openaiApiKey, openaiEndpoint, openaiModel, this.mcpClient);
